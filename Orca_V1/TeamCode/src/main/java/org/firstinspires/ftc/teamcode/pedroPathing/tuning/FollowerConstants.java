...
public class FollowerConstants {
    ...
    private static double xMovement = 77.483;
    private static double yMovement = 44.7677;
    ...
    public static double mass = 13.3;

    // Centripetal force to power scaling
    public static double centripetalScaling = 0.00047;


    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double forwardZeroPowerAcceleration = -24.7644;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -72.5888;
    ...
    public static double zeroPowerAccelerationMultiplier = 3.1;
