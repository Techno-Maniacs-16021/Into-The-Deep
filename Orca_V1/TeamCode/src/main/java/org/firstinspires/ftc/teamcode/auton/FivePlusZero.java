...
public class FivePlusZero extends LinearOpMode {
    ...
    Pose2d pickUp1 = new Pose2d(-22.1,25,Math.toRadians(134.5));
    Pose2d pickUp2 = new Pose2d(-24,35.7,Math.toRadians(132.8));

    Pose2d pickUp3 = new Pose2d(-27.6,45.6,Math.toRadians(117.7));

    Pose2d dropOff1 = new Pose2d(-22.1,25,Math.toRadians(54.2));
    ...
    Vector2d collectSpecimen = new Vector2d(-1.8,35.3);
        ...
        Actions.runBlocking(new SequentialAction(
                ...
                new ParallelAction(
                        orca.actionBuilder(pickUp3)
                                .turn(dropOff3.heading.toDouble()-pickUp3.heading.toDouble())
                                .build(),
