...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 5.042942925248886; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -3.847806203239757; // x position of the perpendicular encoder (in tick units)
    }
